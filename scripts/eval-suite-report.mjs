...
<title>NeoPixel eval suite</title>
<style>
...
<main>
  <h1>NeoPixel</h1>
  <p class="lede">Offline eval suite — Node host CPU and Chromium extension WebGPU/WASM via Playwright. Avg ms hides CF spikes; check p90 and cf columns.</p>
