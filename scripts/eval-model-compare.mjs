...
const MODELS = [
  ...
  },
  {
    ...
    requested: false,
    status: "ok",
    hf: "local distill (OwensLab/commfor-model-384 backbone + NeoPixel head)",
    url: null,
    localPath: "models/neopixel-accurate-v1/model_quantized.onnx",
    seedPaths: [],
    // Filled by npm run distill:accurate → models/neopixel-accurate-v1/manifest.json
    sha256: null,
    inputSize: 384,
    mean: [0.485, 0.456, 0.406],
    std: [0.229, 0.224, 0.225],
...
const report = {
  ...
  note: "Two requested models lacked usable detector ONNX weights; substitutes noted below. Soylent hardcase is a local proxy. We do not fetch private Proofmark quants — train neopixel-accurate-v1 with npm run distill:accurate.",
