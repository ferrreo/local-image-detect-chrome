 ...
 * artifacts unless NEOPIXEL_FORCE_ORT_WEB_PR=1.
 *
...
const force = process.env.NEOPIXEL_FORCE_ORT_WEB_PR === "1";
const prRef = process.env.NEOPIXEL_ORT_PR_REF ?? "pull/29599/head";
